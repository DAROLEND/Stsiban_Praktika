...
namespace AspNetIdentityApp.Controllers
{
    public class FlowerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Category,Price")] Flower flower)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Category,Price")] Flower flower)
        {
            if (ModelState.IsValid)
            {
